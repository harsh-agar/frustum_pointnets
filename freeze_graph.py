...
def freeze_graph_with_def_protos(input_graph_def,
  ...
  #################################################################
  frozen_graph__ = tf.get_default_graph().as_graph_def(output_graph_def)
  tf_model__ = tf.graph_util.remove_training_nodes(frozen_graph__)
  uff_model__ = uff.from_tensorflow(tf_model__,["ENet/logits_to_softmax"])
  #################################################################
